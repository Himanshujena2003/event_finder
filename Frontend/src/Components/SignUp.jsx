...
const SignUp = () => {
  ...
  return (
    <div className="relative w-full h-screen flex items-center justify-center bg-gradient-to-r from-[#1A1A40] via-[#282846] to-[#121212] overflow-hidden">
      ...
      {/* Sign Up Form */}
      <div className="relative bg-[#1E1E1E]/80 backdrop-blur-md p-8 rounded-2xl shadow-lg w-full max-w-md border border-[#2A2A2A]">
        <h1 className="text-5xl font-bold text-[#FFFFFF] text-center mb-6">Sign Up</h1>
